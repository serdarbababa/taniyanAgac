...
class BaseStructure:
    ...
    # addbranch (inputdata)
    #
    # addBranchEntropy(inputdata)
    #
    # checkMatchingBranch(inputdata)
    #
    # checkBranch(inputdata)
    #
    # getBranchGivenStartNodeValue(startNodeValue):
    #
    # getBranchIDsGivenStartNodeValue(startNodeValue):
    #
    # agCizdir(title = "Tree structure", short=False): : simple
    #
    # plotGraph(title = "Tree structure", short=False): : complex
    #
    # learnSymbol(raw_data, verbose):
